...
- [ ] **01b — ai-swarm hardening** — Sibling to 01. Tier 1/2/3 gap close on the substrate Scene 01 stood up: pre-flight probe, `keep_alive`, Reviewer persona tightening, retry policy, test coverage, dockerised orchestrator, structured logging, streaming, multi-round refinement, model routing, LAN auth, HTTP API. Closing condition is Tier 1 must-land + Tier 2 should-land + Tier 3 opportunistic.
