...
4. **Stress-test the Ep2 verdict.** Does *holds with reframing — rules + instrumentation* survive contact with Perplexity's production blog corpus and Grok's contrarian read? Three outcomes: confirms / sharpens / weakens. Cite every claim in the new dumps explicitly.
